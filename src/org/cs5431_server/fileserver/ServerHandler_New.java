...
public class ServerHandler_New extends Thread{
    protected Socket s; //client socket
    String file;
    DataInputStream clientData;
    DataOutputStream output;

    public ServerHandler_New(Socket s) throws IOException{
     ...
     * File is cats.txt
     */
    public void sendHardClient() throws IOException{


        //Wait for client to send name of file over
        System.out.println("Starting to send hard coded to client");
        ...
        try{
            ...
            try{
                ...
                pwrite.println(fileName + " " + myFile.length());
